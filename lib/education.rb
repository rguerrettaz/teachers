...
module Education
    ...
    def call_education(schoolid)
        school_data = JSON.parse(open("http://api.education.com/service/service.php?resf=json&f=getStudentStats&key=fee0d93eb35e6b061392922ddfc720bd&sn=sf&v=4&schoolid=#{schoolid.to_i}").read)
        school_data['school']
    end
